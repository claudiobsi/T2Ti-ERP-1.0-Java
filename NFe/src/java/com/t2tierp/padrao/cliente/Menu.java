...
public class Menu implements MDIController, LoginController {
    ...
    public void loginSuccessful(Map loginInfo) {
        ...
        Domain dominioMotivoDesoneracaoIcms = new Domain("motivoDesoneracaoIcms");
        dominioMotivoDesoneracaoIcms.addDomainPair("1", "Táxi");
        dominioMotivoDesoneracaoIcms.addDomainPair("2", "Deficiente Físico");
        dominioMotivoDesoneracaoIcms.addDomainPair("3", "Produtor Agropecuário");
        dominioMotivoDesoneracaoIcms.addDomainPair("4", "Frotista/Locadora");
        dominioMotivoDesoneracaoIcms.addDomainPair("5", "Diplomático/Consular");
        dominioMotivoDesoneracaoIcms.addDomainPair("6", "Utilitários");

        Domain dominioTributacaoIssqn = new Domain("tributacaoIssqn");
        dominioTributacaoIssqn.addDomainPair("N", "Normal");
        dominioTributacaoIssqn.addDomainPair("R", "Retida");
        dominioTributacaoIssqn.addDomainPair("S", "Substituída");
        dominioTributacaoIssqn.addDomainPair("I", "Isenta");

        Domain dominioTipoOperacaoVeiculo = new Domain("tipoOperacaoVeiculo");
        dominioTipoOperacaoVeiculo.addDomainPair("1", "Venda concessionária");
        dominioTipoOperacaoVeiculo.addDomainPair("2", "Faturamento direto para  consumidor final");
        dominioTipoOperacaoVeiculo.addDomainPair("3", "Venda direta para grandes  consumidores");
        dominioTipoOperacaoVeiculo.addDomainPair("0", "Outros");

        Domain dominioRestricaoVeiculo = new Domain("restricaoVeiculo");
        dominioRestricaoVeiculo.addDomainPair("0", "Não há");
        dominioRestricaoVeiculo.addDomainPair("1", "Alienação Fiduciária");
        dominioRestricaoVeiculo.addDomainPair("2", "Arrendamento Mercantil");
        dominioRestricaoVeiculo.addDomainPair("3", "Reserva de Domínio");
        dominioRestricaoVeiculo.addDomainPair("4", "Penhor de Veículos");
        dominioRestricaoVeiculo.addDomainPair("9", "outras");

        Domain dominioEspecieVeiculo = new Domain("especieVeiculo");
        dominioEspecieVeiculo.addDomainPair("1", "PASSAGEIRO");
        dominioEspecieVeiculo.addDomainPair("2", "CARGA");
        dominioEspecieVeiculo.addDomainPair("3", "MISTO");
        dominioEspecieVeiculo.addDomainPair("4", "CORRIDA");
        dominioEspecieVeiculo.addDomainPair("5", "TRAÇÃO");
        dominioEspecieVeiculo.addDomainPair("6", "ESPECIAL");

        Domain dominioVeiculoCondicaoVin = new Domain("veiculoCondicaoVin");
        dominioVeiculoCondicaoVin.addDomainPair("R", "Remarcado");
        dominioVeiculoCondicaoVin.addDomainPair("N", "Normal");

        Domain dominioVeiculoCondicao = new Domain("veiculoCondicao");
        dominioVeiculoCondicao.addDomainPair("1", "Acabado");
        dominioVeiculoCondicao.addDomainPair("2", "Inacabado");
        dominioVeiculoCondicao.addDomainPair("3", "Semi-acabado");

        Domain dominioTipoArma = new Domain("tipoArma");
        dominioTipoArma.addDomainPair("0", "Uso Permitido");
        dominioTipoArma.addDomainPair("1", "Uso Restrito");
        ...
        domains.put(dominioMotivoDesoneracaoIcms.getDomainId(), dominioMotivoDesoneracaoIcms);
        domains.put(dominioTributacaoIssqn.getDomainId(), dominioTributacaoIssqn);
        domains.put(dominioTipoOperacaoVeiculo.getDomainId(), dominioTipoOperacaoVeiculo);
        domains.put(dominioRestricaoVeiculo.getDomainId(), dominioRestricaoVeiculo);
        domains.put(dominioEspecieVeiculo.getDomainId(), dominioEspecieVeiculo);
        domains.put(dominioVeiculoCondicaoVin.getDomainId(), dominioVeiculoCondicaoVin);
        domains.put(dominioVeiculoCondicao.getDomainId(), dominioVeiculoCondicao);
        domains.put(dominioTipoArma.getDomainId(), dominioTipoArma);
